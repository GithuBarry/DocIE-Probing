...
def get_role_filler_positions(template):
    indices = []
    for role in ['Victim', 'Target', 'PerpInd', 'PerpOrg', "Weapon"]:
...
if __name__ == "__main__":
    f = open(
        "/Users/barry/Library/Mobile Documents/com~apple~CloudDocs/Cornell/Research/Fall 2022-IE/Dataset_Probing/muc_1700_v0.1_GTT_style_triggered-test-dev-train.json")
    import json
    ...
    for file_suffix in ["mucevent_dev.json", "mucevent_test.json", "mucevent_train.json"]:
        fp = open(
            "/Users/barry/Library/Mobile Documents/com~apple~CloudDocs/Cornell/Research/Fall 2022-IE/TANL/data/mucevent_original/"+file_suffix)
        file = json.load(fp)
        fp.close()
        ...
        fp = open(
            "/Users/barry/Library/Mobile Documents/com~apple~CloudDocs/Cornell/Research/Fall 2022-IE/TANL/data/mucevent_original/new_" + file_suffix,"w+")
        json.dump(file, fp)
