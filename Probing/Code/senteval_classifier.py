...
#
# Credit: https://github.com/facebookresearch/SentEval/blob/5d6dc117d1ac30357ddaeb7347fb5684e9b87015/senteval/tools/classifier.py
    ...
    def trainepoch(self, X, y, epoch_size=1):
        ...
        for _ in range(self.nepoch, self.nepoch + epoch_size):
            ...
            for i in range(0, len(X), self.batch_size):
                ...
                # loss
                loss = self.loss_fn(output, ybatch.float())
